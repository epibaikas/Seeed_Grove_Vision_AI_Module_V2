...
SCENARIO_APP_INCDIR += $(SCENARIO_APP_ROOT)/$(APP_TYPE)/inc
SCENARIO_APP_INCDIR += $(SCENARIO_APP_ROOT)/$(APP_TYPE)/inc/platform/grove_vision_we2

SCENARIO_APP_CSRCDIR = $(SCENARIO_APP_ROOT)/$(APP_TYPE)/c_src
SCENARIO_APP_CSRCDIR += $(SCENARIO_APP_ROOT)/$(APP_TYPE)/c_src/platform/grove_vision_we2
