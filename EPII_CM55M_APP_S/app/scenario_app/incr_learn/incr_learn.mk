...
APPL_DEFINES += -DINCR_LEARN
APPL_DEFINES += -DGROVE_VISION_WE2
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/incr_learn_S_only.sct
else #TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/incr_learn_S_only.ld
endif
##
