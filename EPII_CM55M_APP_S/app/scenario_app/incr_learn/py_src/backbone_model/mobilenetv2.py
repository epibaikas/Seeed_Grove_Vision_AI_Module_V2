# Modified version of MobileNetV2
# Inspired by https://github.com/pytorch/vision/blob/main/torchvision/models/mobilenetv2.py
...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        features: List[nn.Module] = [
            # Modified stride to 1
            Conv2dNormActivation(3, input_channel, stride=1, norm_layer=norm_layer, activation_layer=nn.ReLU6)
